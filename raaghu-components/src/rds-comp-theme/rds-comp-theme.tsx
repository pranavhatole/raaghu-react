    ...
    return (
        <>
            <form>
                ...
                <div className="d-flex flex-column-reverse ps-4 pe-4 flex-lg-row flex-md-column-reverse flex-row flex-xl-row flex-xxl-row footer-buttons gap-2 mt-3 pb-3">
                    <RdsButton
                        class="me-2"
                        label="Cancel"
                        type="button"
